<?php    
    ...
    /* We will be checking for amount, account number(incase of paybill), invoice number and inventory.
    But we reserve this for future tutorials*/

    // log the response
    $logFile = "validationResponse.txt";
    // echo "<script>window.open('http://stackoverflow.com', '_blank');</script>";
